...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './academy-course-relation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMYCOURSERELATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACADEMYCOURSERELATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMYCOURSERELATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMYCOURSERELATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMYCOURSERELATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMYCOURSERELATION actions', async () => {
      const expectedActions = [
        {
