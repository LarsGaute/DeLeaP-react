...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './academy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACADEMY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMY actions', async () => {
      const expectedActions = [
        {
