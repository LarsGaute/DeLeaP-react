...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-goal-relations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEGOALRELATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEGOALRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEGOALRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEGOALRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEGOALRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEGOALRELATIONS actions', async () => {
      const expectedActions = [
        {
