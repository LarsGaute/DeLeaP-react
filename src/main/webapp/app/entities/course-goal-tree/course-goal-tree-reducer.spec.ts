...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEGOALTREE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEGOALTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEGOALTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEGOALTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEGOALTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEGOALTREE actions', async () => {
      const expectedActions = [
        {
