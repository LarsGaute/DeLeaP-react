...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRICULUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CURRICULUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURRICULUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURRICULUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURRICULUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURRICULUM actions', async () => {
      const expectedActions = [
        {
